...
const watcher = chokidar.watch(config.watchFolder || defaultConfig.watchFolder, {
...
const createTranslations = () => {
  try {
    ...
    const targetFileContent = getTranslationFileContent(path.resolve(TARGET_FILE))[[config.defaultLocale]]
